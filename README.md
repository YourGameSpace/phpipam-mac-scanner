...
services:
  phpipam-mac-scanner:
    image: ghcr.io/yourgamespace/phpipam-mac-scanner:1.0.0
...
docker run -d \
  ...
  ghcr.io/yourgamespace/phpipam-mac-scanner:1.0.0
```
...
```bash
docker pull ghcr.io/yourgamespace/phpipam-mac-scanner:1.0.0
docker-compose up -d
```
